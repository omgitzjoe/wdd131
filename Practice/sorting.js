...
document.querySelector('#display').innerHTML=simpleSort;
...
document.querySelector('#display2').innerHTML=lowerCaseList;   
...
document.querySelector('#display3').innerHTML=sortedHikes
